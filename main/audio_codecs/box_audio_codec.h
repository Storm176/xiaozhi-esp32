...
private:
    ...
    void CreateDuplexChannels(gpio_num_t mclk, gpio_num_t bclk, gpio_num_t ws, gpio_num_t mclk2, gpio_num_t bclk2, gpio_num_t ws2, gpio_num_t dout, gpio_num_t din);
